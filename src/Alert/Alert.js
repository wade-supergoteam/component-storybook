...
const Alert = styled.div`
  ...
  ${({ type, theme }) =>
    alertVariant(
      themeColorLevel(defaultTheme[type], get(theme, "alertBgLevel", alertBgLevel)),
      themeColorLevel(defaultTheme[type], get(theme, "alertBorderLevel", alertBorderLevel)),
      themeColorLevel(defaultTheme[type], get(theme, "alertColorLevel", alertColorLevel)),
    )}};
`;
