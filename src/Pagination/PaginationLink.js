...
const PaginationLink = styled.a`
  position: relative;
  display: block;
  padding: ${themeProp("paginationPaddingY", paginationPaddingY)} ${themeProp("paginationPaddingX", paginationPaddingX)};
  margin-left: -1px;
  ...
  ${hoverFocus(css`
    ...
    border-color: ${themeProp("paginationHoverBorderColor", paginationHoverBorderColor)};
  `)};
`;
