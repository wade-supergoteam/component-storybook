...
import { progressHeight, progressFontSize, progressBg, progressBorderRadius, progressBoxShadow } from "./default-theme";
...
const Progress = props =>
  props.children ? (
    ...
    <StyledProgress>
      <ProgressBar width={props.width} striped={props.striped} animated={props.animated} />
    </StyledProgress>
  );
