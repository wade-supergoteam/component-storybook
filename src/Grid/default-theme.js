// export const gridMarginBottom = ".5rem";
// export const gridFontFamily = "inherit";
// export const gridFontWeight = "500";
// export const gridLineHeight = "1.2";
// export const gridColor = "inherit";
